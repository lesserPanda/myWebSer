...
<div class="areaTitle">
    <div class="key">我授权的用户</div>
</div>
<s:form action="listAgent.do" method="post" modelAttribute="query">
<div class="areaContent">
    	...
    	<table border="0" cellspacing="5" cellpadding="0">
         <thead>
          <tr>
            ...
            <td>
            	<div class="inputDiv">
            	<s:input path="search['agentUsername']" />
            	</div>
            </td>
          	<th>代理人姓名：</th>
            <td>
            	<div class="inputDiv">
            	<s:input path="search['agentName']" />
            	</div>
            </td>
            <td>
  ...
  <div class="listNews">
      ...
      <tr>
	    ...
	    <th><span class="ls-sort" pagesort="agentName">代理人</span></th>
	  ...
	  <td align="center" class="listEditTd">
		...
		<a class="ls-opt" href="/admin/user/view.do?id=${bean.agentId}&source=agent">查看用户信息</a>
		</shiro:hasPermission>
	  		<shiro:hasPermission name="admin:agent:view">
	  		<a class="ls-opt" href="view.do?id=${bean.id}">查看代理信息</a>
	  		</shiro:hasPermission>
	  		<shiro:hasPermission name="admin:agent:alter">
