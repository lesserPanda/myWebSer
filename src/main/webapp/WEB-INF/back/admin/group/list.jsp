...
<div class="areaContent">
  ...
  <div class="editButtonsArea">
	...
	<shiro:hasPermission name="admin:group:alter">
  ...
  <div class="listNews">
      ...
      <tr>
	    ...
	    <th><span class="ls-sort" pagesort="name">名称</span></th>
	   <%--  <th><span class="ls-sort" pagesort="category">分类</span></th> --%>
        <th width="15%">编辑</th>
      </tr>
      </thead>
      <tbody>
	  ...
	  <tr class="${s.index%2==0?'normal1':'normal2' }">
	    ...
	    <%-- <td align="center">
	    	<c:choose>
        		<c:when test="${bean.category==0}">公文传送</c:when>
        		<c:when test="${bean.category==1}">待扩展</c:when>
        	</c:choose>
	    </td> --%>
