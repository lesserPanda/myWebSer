...
<div class="areaContent">
    	...
    	<table border="0" cellspacing="5" cellpadding="0">
         <thead>
          <tr>
            ...
            <td>
            	<div class="inputDiv">
            	<s:input path="search['musicName']" />
            	</div>
            </td>
          	<th>音乐作者：</th>
            <td>
            	<div class="inputDiv">
            	<s:input path="search['musicAuthor']" />
            	</div>
            </td>
            <td>
  ...
  <div class="listNews">
      ...
      <tr>
	    ...
	    <th><span class="ls-sort" pagesort="musicName">音乐名字</span></th>
	    <th><span class="ls-sort" pagesort="musicAuthor">音乐作者</span></th>
        <th width="15%">编辑</th>
      </tr>
      </thead>
      <tbody>
	  ...
	  <td align="center" class="listEditTd">
	  		...
	  		<shiro:hasPermission name="MusicInfo:musicInfo:alter">
