...
<div class="areaContent">
    	...
    	<table border="0" cellspacing="5" cellpadding="0">
         <thead>
          <tr>
            ...
            <td>
            	<div class="inputDiv">
            	<s:input path="search['messagePerple']" />
            	</div>
            </td>
          	<th>留言时间：</th>
            <td>
            	<div class="inputDiv">
            	<s:input path="search['createTime']" />
            	</div>
            </td>
            <td>
  ...
  <div class="listNews">
      ...
      <tr>
	    ...
	    <th><span class="ls-sort" pagesort="messagePerple">留言人姓名</span></th>
	    <th><span class="ls-sort" pagesort="messagePerpleIp">留言人ip</span></th>
	    <th><span class="ls-sort" pagesort="createTime">留言时间</span></th>
        <th width="15%">编辑</th>
      </tr>
      </thead>
      <tbody>
	  ...
	  <td align="center" class="listEditTd">
	  		...
	  		<shiro:hasPermission name="MessagePerple:messagePerple:alter">
